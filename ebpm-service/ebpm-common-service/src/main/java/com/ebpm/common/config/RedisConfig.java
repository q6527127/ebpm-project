...
//    }
    ...
    public RedisTemplate<String, Object> redisTemplate2(RedisConnectionFactory factory){
        ...
        template.afterPropertiesSet();
        //切库
        return initRedis(2, template);
    }
    
  //切库
    private  RedisTemplate initRedis(Integer indexDb, StringRedisTemplate redisTemplate){
