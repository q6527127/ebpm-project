...
/**
 *  * @Title: RandomHelper.java  * @Package com.jarvis.base.util
 *  * @Description: 随机数工具类  * @version V1.0  
 */
public class RandomUtil {
	...
	/**
	 *  * 产生指定长度的数字值随机数  *  * @param length  * 需要产生的长度  * @return  
	 */
	...
	/**
	 *  * 描述：手机验证码生成带字符，包含数字和字符 作者： 时间：Oct 29, 2008 3:40:07 PM  *  * @param len  *
	 * 生成手机验证码长度  * @return  
	 */
	...
	/**
	 *  * 描述：手机验证码生成带字符不包含数字  *  * @param len  * 生成手机验证码长度  * @return
	 */
